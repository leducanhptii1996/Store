...
class TabNikeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    var mShoe =  [Shoe]()
    ...
    @IBOutlet weak var mColectionNikeView: UICollectionView!
    ...
    func requestData() {
        ...
        NikeTabService.getShoeData { (arrShoe) in
            ...
            DispatchQueue.main.async {
                ...
                self.mColectionNikeView.reloadData()
            }
...
//        cartScene.navigationItem.title = "Trở về"
    ...
    override func viewDidLoad() {
        ...
        //register xib
        mColectionNikeView.register(UINib(nibName: "CollectionCellController", bundle: nil), forCellWithReuseIdentifier: collectionCellController)
...
//        detailScene.navigationItem.title = mShoe[indexPath.row].name
